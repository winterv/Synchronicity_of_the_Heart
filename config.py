...
UDP_IP_robot_hearts = '192.168.1.32'
UDP_PORT_robot_hearts = 21324
...
USE_LOOPBACK = True
"""Set to True to capture audio output (speakers/headphones) instead of microphone input.
On Windows, this uses WASAPI loopback mode to capture what's playing through the speakers.
On Linux/Mac, you may need to configure a virtual audio device (e.g., PulseAudio loopback, JACK, etc.)
"""